...
function ModifyDialog({
  ...
  const [publishQuantal, setPublishQuantal] = useState(
    dialogData.published_qty
  );
  ...
  async function handleModify() {
    ...
    if (!confirRes) return;
    const data = {
      tender_id: dialogData.tender_id,
      sale_rate: saleRate,
      published_qty: publishQuantal,
    };
    const res = await loaderWrapper(modifySingleTrade(data));
    if (res.success) {
      setListItemData((prev) => ({
        ...prev,
        sale_rate: saleRate,
        published_qty: publishQuantal,
      }));
  ...
  return (
    <div className="dialog-container">
      <div className="dialog-box">
        <div className="dialog-title">Modify Published Item</div>
        <div className="dialog-content">
          ...
          <div className="dialog-row">
            ...
            <div className="dialog-cell">
              ...
              <input
                type="number"
                value={publishQuantal}
                onChange={handlePublishQuantalChange}
              />
            </div>
          </div>
          <div className="dialog-row">
