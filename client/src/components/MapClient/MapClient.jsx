...
function MapClient() {
  ...
  const [accountData, setAccountData] = useState({
    accoid: "", Ac_Name_E: "none", Ac_Code: "NA", Address_E: "NA", Gst_No: "NA"
  })
        ...
        loading ? <Loader /> :
          <div className="map-container">
            ...
            <div className="user-data-container">
                ...
                <select onChange={handleDropDownChange} value={accountData.accoid}>
                  <option value="none" hidden={true}>--Select--</option>
                  {
                    accountDropdown.map(acc => {
                      return <option value={acc.accoid} key={acc.accoid}>{acc.Ac_Name_E}</option>
                    })
                  }
                </select>
              </div>
              ...
              <div>
                <label htmlFor="">Address:</label>
                <span>{accountData.Address_E?.length ? accountData.Address_E : "NA"}</span>
              </div>
              <div>
                <label htmlFor="">Gst No: </label>
              ...
              <div className="map-btns">
                <button className="cancel"  onClick={handleCancelMap}>Cancel</button>
                <button className="save" id="cancel" onClick={handleMapClient}>Map Client</button>
              </div>
            </div>
          </div>
      }
